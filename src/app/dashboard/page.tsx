  ...
  return (
      ...
      <div className="w-full min-h-screen h-full bg-white p-5 pb-20">
        <div className="w-full flex justify-center relative">
          ...
          <h1 className="xs:text-xl xxs:text-md font-bold text-black dark:text-black">Éppi Ads</h1>
        </div>
        ...
        <div className="flex flex-col pt-5 gap-5">
          ...
          {
            carOffer && carOffer.length === 0 ?
            <div className="w-full h-[15rem] flex flex-col justify-center items-center gap-5">
              <Image src={"https://res.cloudinary.com/dmo7nzytn/image/upload/v1757886696/undraw_empty_xct9_1_wlqjpe.svg"} alt={""} width={200} height={200} />
              <span className="text-[#838383] text-[0.925rem]">Parece que não há anúncios para você no momento.</span>
            </div>
            :
