        ...
        <div className="flex overflow-x-scroll gap-3">
          ...
          .map((carro: any, index: number)=>{
            return <Link
              href={{
                pathname: '/offer',
                query: { id: carro.id, lat: coor?.lat, long: coor?.long, storeCode: carro.storeCode },
              }}
              key={index}
              className="relative"
            >
              <Image quality={100} priority={true} className="xxs:w-[202px] xxs:h-[117px] xs:w-[232px] xs:h-[147px] rounded-lg mb-2 xs:min-w-[232px] xs:min-h-[147px] xxs:min-w-[202px] xxs:min-h-[117px] bg-cover" src={carro.image!} alt={""} width={230} height={125}/>
